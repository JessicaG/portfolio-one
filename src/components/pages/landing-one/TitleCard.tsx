...
const TitleCard = () => {
  return (
    <div className="card-style title-card">
      <span className="title-card__title-sub-text heading-4">Experienced</span>
      <div className="title-card__title-text ">
        <h2 className="heading-2">Developer</h2>
        <h2 className="title-card__title-text-two heading-2">Leader</h2>
      </div>
      <Image
        src={titleCardShape}
        width={58}
