...
const LinkPrimaryTwo = ({
  ...
  return (
    <div
      className={`d-flex justify-content-between align-items-center link-primary-two ${className}`}
    >
      <div className="link-primary-two__content">
        <span className="link-primary-two__content__text textM">
          {linkText}
        </span>
      </div>
      <Link href={`${link}`} className="link-primary-two__image">
        <svg
