...
const LinkPrimary = ({
  ...
  return (
    <div
      className={`d-flex justify-content-between align-items-center link-primary ${className}`}
    >
      <div className="link-primary__content">
        <span className="link-primary__content__text textM">{linkText}</span>
      </div>
      <Link href={`${link}`} className="link-primary__image">
        <svg
